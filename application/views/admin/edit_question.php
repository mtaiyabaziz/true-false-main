...
<body>
  ...
  <div class="container" style="margin-top: 1%">
    ...
    <div class="row">
      <div class="col-md-6">
        <?php  echo form_open_multipart('admin/update_question'); ?>
            <input style="visibility:hidden" type="text" class="form-control" id="question" name="id"  value="<?php echo $question->id; ?>">
          <div class="form-group">
            <label >Question:</label>
            <input type="text" class="form-control" id="question" name="question"  placeholder="Enter Question" value="<?php echo $question->question; ?>">
          </div>
          <div class="row">
          ...
          <img src="<?php echo $question->image; ?>" class="img-thumbnail"  width="304" height="236">
          <div class="form-group">
            <label for="exampleFormControlFile1"> Select Another Image:</label> <br>
            <?php echo form_upload(['name' => 'image']); ?>
          </div>
          <div class="row">
          <div class="col-md-12 " style="height:20px;color:#DC3545">
    ...
    <div class="row d-flex justify-content-center mt-5">
      ...
      <a href="<?= base_url('admin/select') ?>" class="btn btn-info float-right mb-5">Seel All Questions</a>
      </div>
    </div>
  </div>
